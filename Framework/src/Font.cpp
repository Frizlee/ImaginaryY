...
Font::Font(const std::string & facePath, std::uint8_t size, ResourceHandle<ImageAtlas> atlas, 
	float spacing)
{
	...
	create(facePath, size, atlas);
}

void Font::create(const std::string & facePath, std::uint8_t size, ResourceHandle<ImageAtlas> atlas, 
	float spacing)
{
